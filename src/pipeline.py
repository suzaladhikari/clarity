...
combined_results = {}
combined_results['mae'] = [lstm_model_results['mae'], rnn_model_results['mae'], garch_results['mae']]
combined_results['rmse'] = [lstm_model_results['rmse'], rnn_model_results['rmse'], garch_results['rmse']]
combined_results['r2'] = [lstm_model_results['r2'], rnn_model_results['r2'], garch_results['r2']]
